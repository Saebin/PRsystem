...
public class GCMUtil {
    static final String API_KEY = "AIzaSyDoiog_f78GxHPIlULjZzVipfnULnWTLtk"; // server api key
    ...
    private void setMessage(GCMVo gcmVo) {
        ...
        builder.addData(TITLE_EXTRA_KEY, URLDecoder.decode(gcmVo.getTitle()));
        builder.addData(MSG_EXTRA_KEY, URLDecoder.decode(gcmVo.getMsg()));
